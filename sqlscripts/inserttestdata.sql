...
0,               0,               0,                   0,                    '0010001'); -- Creates fresh TableOrder
                    --SCOPE_IDENTITY() is a method that returns the last autogenerated identity in this transaction
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableCode='0010001';  -- Assigns chosen table with the TableOrder
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableCode='0010002'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableCode=0010003; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableCode='0020001'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableCode='0020002'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableCode='0020003'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableCode='0030001'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableCode='0030002'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableCode='0030003';
