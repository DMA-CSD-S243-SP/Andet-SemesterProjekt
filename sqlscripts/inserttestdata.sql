...
0,               0,               0,                   0,                    1 ,		  '001'); -- Creates fresh TableOrder
                    --SCOPE_IDENTITY() is a method that returns the last autogenerated identity in this transaction
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableNumber = 1 AND restaurantCode = '001';  -- Assigns chosen table with the TableOrder
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableNumber = 2 AND restaurantCode = '001'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableNumber = 3 AND restaurantCode = '001'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableNumber = 1 AND restaurantCode = '002'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableNumber = 2 AND restaurantCode = '002'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableNumber = 3 AND restaurantCode = '002'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableNumber = 1 AND restaurantCode = '003'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableNumber = 2 AND restaurantCode = '003'; 
...
UPDATE [Object_Table] SET tableOrderId=SCOPE_IDENTITY() WHERE tableNumber = 3 AND restaurantCode = '003';
